# PHASE-10: Settings Auth

## Purpose
Implement schemas, authentication, roles, and audit.
...
5. Run `scripts/github/create-phase-checkpoint.sh PHASE-10 "Settings Auth" origin` to create the commit, immutable tag, remote push, and snapshot.
9. Run `scripts/github/verify-phase-closeout.sh PHASE-10 origin` on Linux to verify tag identity, commit reachability, snapshot SHA-256, and recorded evidence.
