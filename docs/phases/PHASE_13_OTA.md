...
## Purpose
Implement secure A/B OTA and rollback.
...
5. Run `scripts/github/create-phase-checkpoint.sh PHASE-13 "OTA" origin` to create the commit, immutable tag, remote push, and snapshot.
