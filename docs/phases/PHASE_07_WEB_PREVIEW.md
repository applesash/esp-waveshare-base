# PHASE-07: Web Preview

## Purpose
Render the same UI locally with simulation and contract tests.
...
5. Run `scripts/github/create-phase-checkpoint.sh PHASE-07 "Web Preview" origin` to create the commit, immutable tag, remote push, and snapshot.
9. Run `scripts/github/verify-phase-closeout.sh PHASE-07 origin` on Linux to verify tag identity, commit reachability, snapshot SHA-256, and recorded evidence.
