# PHASE-08: Three Board Acceptance

## Purpose
Run Hello acceptance on all three devices.
...
5. Run `scripts/github/create-phase-checkpoint.sh PHASE-08 "Three Board Acceptance" origin` to create the commit, immutable tag, remote push, and snapshot.
9. Run `scripts/github/verify-phase-closeout.sh PHASE-08 origin` on Linux to verify tag identity, commit reachability, snapshot SHA-256, and recorded evidence.
