...
## Purpose
Implement AP/STA provisioning and shared workflow.
...
5. Run `scripts/github/create-phase-checkpoint.sh PHASE-09 "Network Provisioning" origin` to create the commit, immutable tag, remote push, and snapshot.
9. Run `scripts/github/verify-phase-closeout.sh PHASE-09 origin` on Linux to verify tag identity, commit reachability, snapshot SHA-256, and recorded evidence.
