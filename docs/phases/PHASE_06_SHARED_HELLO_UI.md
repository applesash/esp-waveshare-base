# PHASE-06: Shared Hello Ui

## Purpose
Create one counter model/workflow and render with LVGL.
...
5. Run `scripts/github/create-phase-checkpoint.sh PHASE-06 "Shared Hello UI" origin` to create the commit, immutable tag, remote push, and snapshot.
9. Run `scripts/github/verify-phase-closeout.sh PHASE-06 origin` on Linux to verify tag identity, commit reachability, snapshot SHA-256, and recorded evidence.
