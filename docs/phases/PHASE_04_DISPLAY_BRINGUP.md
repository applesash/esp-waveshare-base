# PHASE-04: Display Bringup

## Purpose
Validate power, backlight, RGB timing, colour bars, and static labels.
...
5. Run `scripts/github/create-phase-checkpoint.sh PHASE-04 "Display Bringup" origin` to create the commit, immutable tag, remote push, and snapshot.
9. Run `scripts/github/verify-phase-closeout.sh PHASE-04 origin` on Linux to verify tag identity, commit reachability, snapshot SHA-256, and recorded evidence.
