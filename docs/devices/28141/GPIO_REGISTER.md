...
| ISOLATED_DO0 | N/A | CH422G OC0 (library channel 8) | Output | vendor loopback uses high as active; output mode is push-pull | N/A | source test initializes high | owner-approved: unconfigured until authorized I/O service ownership | Official 4.3B-BOX Arduino `05_IO_Test/waveshare_io_port.h`; `waveshare_io_port.cpp`; CH422G datasheet | VERIFIED |
| ISOLATED_DO1 | N/A | CH422G OC1 (library channel 9) | Output | vendor loopback uses high as active; output mode is push-pull | N/A | source test initializes high | owner-approved: unconfigured until authorized I/O service ownership | Official 4.3B-BOX Arduino `05_IO_Test/waveshare_io_port.h`; `waveshare_io_port.cpp`; CH422G datasheet | VERIFIED |
