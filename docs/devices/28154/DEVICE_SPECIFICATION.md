...
The display controller family is ST7701 with 16-bit RGB timing/data signals and serial control. R0 and B0 are unused in the documented wiring. Display reset and backlight control are mediated by the CH32V003 helper controller; exact initialization commands and timing values remain an implementation gate.
