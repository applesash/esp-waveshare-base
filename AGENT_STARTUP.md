...
4. Run the OS-appropriate checkpoint script from the repository root; on Linux use `scripts/github/create-phase-checkpoint.sh` and `scripts/github/verify-phase-closeout.sh`.
