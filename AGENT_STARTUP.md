...
13. Run required tests and update status, traceability, evidence, and changelog. Use `docs/recovery/PHYSICAL_VALIDATION_RUNBOOK.md` for exact-board validation.
...
4. Run the OS-appropriate checkpoint script from the repository root; on Linux use `scripts/github/create-phase-checkpoint.sh`, `scripts/github/finalize-phase-closeout.sh`, and `scripts/github/verify-phase-closeout.sh`.
